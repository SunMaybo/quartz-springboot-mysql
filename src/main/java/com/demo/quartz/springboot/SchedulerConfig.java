package com.demo.quartz.springboot;

import javax.sql.DataSource;

import com.demo.quartz.springboot.job.SampleJob;
import com.demo.quartz.springboot.spring.AutowiringSpringBeanJobFactory;
...
public class SchedulerConfig {
    ...
    public CronTriggerFactoryBean cronTrigger(@Qualifier("sampleJobDetail") JobDetail jobDetail, @Value("${samplejob.corn}") String corn) {
        return createCronTrigger(jobDetail, corn);
    }
